...
- Validate JSON file existence and structure
- Support for performing CRUD-like operations on JSON data (e.g., reading, saving, and querying data)
...
on [Maven Central](https://central.sonatype.com/artifact/com.techbasecore/jsonlite/versions)
...
```groovy
implementation group: 'com.techbasecore', name: 'jsonlite', version: '1.0.0'
```
